        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResetSessionToken = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PasswordResetOtps_ResetSessionToken",
                table: "PasswordResetOtps",
                column: "ResetSessionToken",
                unique: true,
                filter: "[ResetSessionToken] IS NOT NULL");
