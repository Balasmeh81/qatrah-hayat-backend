        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MergedIntoUserId = table.Column<int>(type: "int", nullable: true),
                    MergedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BloodRequesters", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GPSLat = table.Column<decimal>(type: "decimal(9,6)", nullable: true),
                    GPSLng = table.Column<decimal>(type: "decimal(9,6)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampaignTargetBloodTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CampaignTargetBloodTypes_Campaigns_CampaignId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignTargetBloodTypes_CampaignId",
                table: "CampaignTargetBloodTypes",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_Hospitals_BranchId",
                table: "Hospitals",
                column: "BranchId");
        }
