...
namespace QatratHayat.Infrastructure.Persistence
{
    public class AppDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, int>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // NationalRegistry
            builder.Entity<NationalRegistry>(entity =>
            {
            ...
            builder
                ...
                .HasData(
                    ...
                    {
                        Id = 1,
                        Name = UserRole.Citizen.ToString(),
                        NormalizedName = UserRole.Citizen.ToString().ToUpper(),
                    },
                    new ApplicationRole
                    {
                        Id = 2,
                    ...
                    {
                        Id = 4,
                        Name = UserRole.BranchManager.ToString(),
                        NormalizedName = UserRole.BranchManager.ToString().ToUpper(),
                    },
                    new ApplicationRole
                    {
                        Id = 5,
            ...
            builder.Entity<PasswordResetOtp>(entity =>
            {
                ...
                entity
                    .HasIndex(x => x.ResetSessionToken)
                    .IsUnique()
                    .HasFilter("[ResetSessionToken] IS NOT NULL");

                entity.Property(x => x.OtpHash).HasMaxLength(256).IsRequired();

                entity.Property(x => x.ResetSessionToken).HasMaxLength(128);
            });
            ...
            builder.Entity<BloodUnit>(entity =>
            {
                ...
                entity.HasIndex(x => x.DonationId).IsUnique();
            ...
            builder.Entity<Branch>(entity =>
            {
                ...
                entity.HasIndex(x => x.ManagerUserId).IsUnique();
            });
            // BranchWorkingHour
            ...
            builder.Entity<ScreeningAnswer>(entity =>
            {
                ...
                entity
                    .HasOne<ApplicationUser>()
                    .WithMany()
                    .HasForeignKey(a => a.ReviewedByEmployeeId)
                    .OnDelete(DeleteBehavior.Restrict);
            ...
            builder
                ...
                .HasData(
                    ...
                    new ScreeningQuestion
                    {
                        ...
                        TextEn =
                            "Have you ever experienced reactions after blood donation such as dizziness, fainting, or others?",
                        SessionType = ScreeningSessionType.Registration,
                        DeferralType = DeferralType.NoDeferral,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 3,
                        TextAr =
                            "هل أنت مصاب بأمراض الدم الوراثية مثل الثلاسيميا أو فقر الدم المنجلي أو فقر الدم المزمن أو غيرها؟",
                        TextEn =
                            "Do you have hereditary blood disorders such as thalassemia, sickle cell disease, chronic anemia, or others?",
                        SessionType = ScreeningSessionType.Registration,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 4,
                        TextAr =
                            "هل أنت مصاب بأمراض نزف الدم أو أي نقص خلقي في أحد عوامل التخثر مثل الهيموفيليا أو غيرها؟",
                        TextEn =
                            "Do you have bleeding disorders or congenital clotting factor deficiencies such as hemophilia or others?",
                        SessionType = ScreeningSessionType.Registration,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 5,
                        TextAr =
                            "هل أنت مصاب بأمراض المناعة الذاتية مثل مرض بهجت أو الذئبة أو حمى البحر الأبيض المتوسط أو الروماتيزم أو الصدفية أو البهاق أو الثعلبة أو غيرها؟",
                        TextEn =
                            "Do you have autoimmune diseases such as Behçet’s disease, lupus, familial Mediterranean fever, rheumatism, psoriasis, vitiligo, alopecia, or others?",
                        SessionType = ScreeningSessionType.Registration,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 107,
                        TextAr =
                            "هل خالطت شخصًا مصابًا بالتهاب الكبد الفيروسي خلال الاثني عشر شهرًا الماضية؟",
                        TextEn =
                            "Have you had close contact with someone with viral hepatitis during the past 12 months?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Temporary,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 108,
                        TextAr =
                            "هل أنت مصاب بأحد الأمراض المعدية التي تنتقل عن طريق الدم مثل الإيدز أو السفلس؟",
                        TextEn =
                            "Do you have any blood-borne infectious diseases such as HIV/AIDS or syphilis?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Permanent,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 109,
                        TextAr =
                            "هل أنت مصاب بأي من أمراض الرئة أو القلب أو الكلى أو السكري المعتمد على الإنسولين أو ارتفاع ضغط الدم؟",
                        TextEn =
                            "Do you have any of the following conditions: lung disease, heart disease, kidney disease, insulin-dependent diabetes, or high blood pressure?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 111,
                        TextAr =
                            "هل تناولت أسبرين أو أي دواء يحتوي على مكونات الأسبرين خلال الثلاثة أيام الماضية؟",
                        TextEn =
                            "Have you taken aspirin or any medication containing aspirin during the past 3 days?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 112,
                        TextAr =
                            "هل تناولت أي مسكنات للألم أو مضادات للالتهاب خلال الثلاثة أيام الماضية؟",
                        TextEn =
                            "Have you taken any painkillers or anti-inflammatory medications during the past 3 days?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        ...
                        TextEn =
                            "Have you had a tooth extraction or dental treatment during the past 7 days?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 114,
                        TextAr =
                            "هل تعرضت لثقب بالأذن أو الجلد أو للعلاج بالإبر الصينية خلال الاثني عشر شهرًا الماضية؟",
                        TextEn =
                            "Have you had ear/body piercing or acupuncture during the past 12 months?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Temporary,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        ...
                        TextEn =
                            "Have you received a blood transfusion or blood products during the past 12 months?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Temporary,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 119,
                        TextAr =
                            "هل استخدمت إبرًا لأخذ أي نوع من المخدرات عن طريق الوريد أو تحت الجلد؟",
                        TextEn =
                            "Have you ever used needles to take non-prescribed drugs intravenously or under the skin?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Permanent,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = false,
                    ...
                    new ScreeningQuestion
                    {
                        ...
                        TextEn =
                            "For women: Have you been pregnant or had a miscarriage during the past 9 months?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.Temporary,
                        DecisionMode = ScreeningDecisionMode.AutoDeferralWhenYes,
                        IsForFemaleOnly = true,
                    ...
                    new ScreeningQuestion
                    {
                        Id = 124,
                        TextAr =
                            "للنساء: هل تعانين الآن من الدورة الشهرية مع زيادة في كمية الدم المفقودة؟",
                        TextEn =
                            "For women: Are you currently menstruating with increased blood loss?",
                        SessionType = ScreeningSessionType.PreDonation,
                        DeferralType = DeferralType.NoDeferral,
                        DecisionMode = ScreeningDecisionMode.ReviewWhenYes,
                        IsForFemaleOnly = true,
